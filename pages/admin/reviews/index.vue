...
export default {
    ...
    methods: {
        ...mapActions({
            ...
            'actReadReview' : 'Review/actReadReview',
            'actReadAllReviews' : 'Review/actReadAllReviews'
        }),
        readReview(data){
            this.actReadReview({
                id: data
        ...
        readAllReviews(){
            this.actReadAllReviews(this.getReviews.map(x => x.id))
        },  
        showConfirm(data) {
            this.confirm = ''
            ...
            .then(value => {
                this.confirm = value
                if(this.confirm){
                    this.actRemoveReview({index: data.index + this.calPagination,id: data.item.id})
                }
            })
            .catch(err => {
                console.log(err);
